...
/**
 * R1.2.x §24.4 RepositoryEntryParser（neo26.x 适配版，行为等价搬运）。
 *
 * <p>index.json 条目解析与 URL/字符串工具，含本分支的 HttpTransport.debugLogEnabled() 调试日志。
 */
public final class RepositoryEntryParser {
    ...
    public static List<ModelRepoEntry> parseIndex(String indexUrl, String json) {
