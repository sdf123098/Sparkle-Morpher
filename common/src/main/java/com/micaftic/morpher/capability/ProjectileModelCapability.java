...
public class ProjectileModelCapability {
        ...
        return com.micaftic.morpher.neoforge.capability.NeoForgeCapabilities.getProjectileModel(entity);
    }

        public static Optional<ProjectileModelCapability> get(Projectile projectile) {
        return com.micaftic.morpher.neoforge.capability.NeoForgeCapabilities.getProjectileModel(projectile);
    }
