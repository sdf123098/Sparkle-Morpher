...
public final class SmExecutors {
    ...
    public enum Pool {
        MODEL_PARSE, MODEL_IO, NETWORK_IO, SYNC_NETWORK, BACKGROUND
    }
    ...
    public static void shutdown() {
        for (ExecutorService executor : new ExecutorService[]{MODEL_PARSE, MODEL_IO, NETWORK_IO, SYNC_NETWORK, BACKGROUND}) {
            executor.shutdown();
        }
    }
