...
public final class ResourceApi {
    ...
    public static ResourceId parse(String value) {
        ...
        return separator < 0 ? new ResourceId("minecraft", value) : new ResourceId(value.substring(0, separator), value.substring(separator + 1));
    }
    ...
    public record ResourceId(String namespace, String path) {
        public ResourceId { if (namespace == null || namespace.isBlank() || path == null || path.isBlank()) throw new IllegalArgumentException("Resource id requires namespace and path"); }
        public String asString() { return namespace + ":" + path; }
    }
}
