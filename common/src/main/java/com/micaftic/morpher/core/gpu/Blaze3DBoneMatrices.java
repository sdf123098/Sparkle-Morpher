...
public final class Blaze3DBoneMatrices {
    ...
    /**
     * 供现代 HUD（client.renderer.modernhud 包）复用：CPU 计算骨骼矩阵到 80B/bone 布局
     * （26.1.2 UBO 版：mat4 transform + vec4 meta；法线矩阵不放 UBO，由 shader
     * inverse(transpose(mat3(boneTransform))) 求）。26.2 的 144B 版含预计算法线矩阵，
     * 该文件在 26.1.2 与 26.2 分叉。
     */
