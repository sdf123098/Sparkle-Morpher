...
import static com.micaftic.morpher.core.zstd.BitInputStream.peekBits;
import static com.micaftic.morpher.core.zstd.Constants.COMPRESSED_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static com.micaftic.morpher.core.zstd.Constants.LITERALS_LENGTH_BITS;
import static com.micaftic.morpher.core.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static com.micaftic.morpher.core.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static com.micaftic.morpher.core.zstd.Constants.MAGIC_NUMBER;
import static com.micaftic.morpher.core.zstd.Constants.MATCH_LENGTH_BITS;
import static com.micaftic.morpher.core.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static com.micaftic.morpher.core.zstd.Constants.MAX_BLOCK_SIZE;
import static com.micaftic.morpher.core.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static com.micaftic.morpher.core.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static com.micaftic.morpher.core.zstd.Constants.MIN_BLOCK_SIZE;
import static com.micaftic.morpher.core.zstd.Constants.MIN_SEQUENCES_SIZE;
import static com.micaftic.morpher.core.zstd.Constants.MIN_WINDOW_LOG;
import static com.micaftic.morpher.core.zstd.Constants.OFFSET_TABLE_LOG;
import static com.micaftic.morpher.core.zstd.Constants.RAW_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.RAW_LITERALS_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.RLE_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.RLE_LITERALS_BLOCK;
import static com.micaftic.morpher.core.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static com.micaftic.morpher.core.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static com.micaftic.morpher.core.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static com.micaftic.morpher.core.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static com.micaftic.morpher.core.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static com.micaftic.morpher.core.zstd.Constants.SIZE_OF_BYTE;
import static com.micaftic.morpher.core.zstd.Constants.SIZE_OF_INT;
import static com.micaftic.morpher.core.zstd.Constants.SIZE_OF_LONG;
import static com.micaftic.morpher.core.zstd.Constants.SIZE_OF_SHORT;
import static com.micaftic.morpher.core.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static com.micaftic.morpher.core.zstd.UnsafeUtil.UNSAFE;
import static com.micaftic.morpher.core.zstd.Util.fail;
import static com.micaftic.morpher.core.zstd.Util.get24BitLittleEndian;
import static com.micaftic.morpher.core.zstd.Util.mask;
import static com.micaftic.morpher.core.zstd.Util.verify;
