...
public class YSMParser {
    ...
    public static boolean parse(String ysmFilePath, String outputDir) {
        throw unavailable();
    }

    public static boolean parseBytes(byte[] ysmData, String outputDir) {
        throw unavailable();
    }

    public static int getVersion(String ysmFilePath) {
        throw unavailable();
    }
}
