...
public final class ConfigPolicies {
    ...
    public static FeaturePolicy features() { return new FeaturePolicy(bool(GeneralConfig.EXPERIMENTAL_FALLBACK_ELYTRA_WITHOUT_LOCATOR, false), bool(GeneralConfig.EXPERIMENTAL_ENABLE_ELYTRA_FOR_DEFAULT_AND_MISC_MODELS, false), bool(GeneralConfig.VULKAN_EXPERIMENTAL_CAPABILITY_PROBE, false), true, false); }
