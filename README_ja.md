...
デフォルトのプレイヤーモデルを完全にカスタムされた 3D モデルに置き換えます。すべてのカスタムモデルはマルチプレイヤーで**他のプレイヤーにも表示されます**——サーバーサイドのMOD不要でモデルの可視性を実現。
...
4 つのビルドバージョンでで主要MODローダーとバージョンの組み合わせを網羅：

| バリアント | ローダー | Minecraft バージョン |
|-----------|---------|-------------------|
