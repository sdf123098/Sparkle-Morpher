...
public class DownloadScreen extends Screen {
    ...
    protected void init() {
        ...
        int footerY = this.guiTop + this.panelHeight - 18;
        addRenderableWidget(new IconButton(this.guiLeft + 6, footerY, 18, 18, 0, 32, button -> {
            Minecraft.getInstance().setScreen(this.resourceStationScreen == null ? this.parentScreen : this.resourceStationScreen);
        }));
        IconButton clearButton = new IconButton(this.guiLeft + 28, footerY, 18, 18, 96, 64, button -> ResourceDownloadManager.clearFinished());
        ...
        IconButton cancelButton = new IconButton(this.guiLeft + 50, footerY, 18, 18, 112, 64, button -> {
