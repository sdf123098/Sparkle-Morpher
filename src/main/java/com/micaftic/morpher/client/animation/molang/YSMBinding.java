...
public class YSMBinding extends ContextBinding {
    ...
    private YSMBinding() {
        ...
        clientPlayerEntityVar("elytra_rot_x", ctx -> Math.toDegrees(ctx.entity().elytraAnimationState.getRotX(ctx.animationEvent().getPartialTick())));
        clientPlayerEntityVar("elytra_rot_y", ctx -> Math.toDegrees(ctx.entity().elytraAnimationState.getRotY(ctx.animationEvent().getPartialTick())));
        clientPlayerEntityVar("elytra_rot_z", ctx -> Math.toDegrees(ctx.entity().elytraAnimationState.getRotZ(ctx.animationEvent().getPartialTick())));
