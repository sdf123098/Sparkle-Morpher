...
public final class ClientRenderCompatibilityRegistry {
    ...
    public static ResourceLocation resolveTextureLocation(OuterFileTexture texture) {
        for (ClientRenderCompatibility module : MODULES) {
            try {
                ResourceLocation location = module.resolveTextureLocation(texture);
    ...
    public static void onTextureRegistered(ResourceLocation location, OuterFileTexture texture, boolean replaced) {
        dispatch("register texture", module -> module.onTextureRegistered(location, texture, replaced));
    }

    public static void onTextureUploaded(ResourceLocation location, OuterFileTexture texture) {
        dispatch("upload texture", module -> module.onTextureUploaded(location, texture));
    }

    public static void onTextureInactive(ResourceLocation location) {
