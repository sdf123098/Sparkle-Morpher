...
public interface ClientRenderCompatibility {
    ...
    default ResourceLocation resolveTextureLocation(OuterFileTexture texture) {
        return null;
    }
    ...
    default void onTextureRegistered(ResourceLocation location, OuterFileTexture texture, boolean replaced) {
    }

    default void onTextureUploaded(ResourceLocation location, OuterFileTexture texture) {
    }

    default void onTextureInactive(ResourceLocation location) {
    }
