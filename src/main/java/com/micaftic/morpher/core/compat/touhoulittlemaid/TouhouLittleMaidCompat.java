...
public final class TouhouLittleMaidCompat {
    ...
    public static boolean isMaidRideable(Entity entity) { return TouhouLittleMaidAccess.isMaid(entity);
    }

    public static boolean isSimplePlanesEntity(Entity entity) { return TouhouLittleMaidAccess.isChair(entity);
    }

    public static boolean isImmersiveAircraftEntity(Entity entity) { return TouhouLittleMaidAccess.isSit(entity);
    }

    public static boolean isMaidItem(Item item) { return TouhouLittleMaidAccess.isGohei(item);
    }
    ...
    public static boolean isMaidSitting(LivingEntity livingEntity) { return TouhouLittleMaidAccess.hasFishingHook(livingEntity);
    }
