...
public class LoadingStateConfig {
    ...
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_LOADING_STATE_SCREEN;

    public static net.neoforged.neoforge.common.ModConfigSpec.EnumValue<Position> LOADING_STATE_POSITION;
