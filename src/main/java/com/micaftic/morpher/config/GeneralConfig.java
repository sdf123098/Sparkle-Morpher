...
public class GeneralConfig {
    ...
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISCLAIMER_SHOW;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue PRINT_ANIMATION_ROULETTE_MSG;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_SELF_MODEL;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_OTHER_MODEL;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_SELF_HANDS;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_PROJECTILE_MODEL;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_VEHICLE_MODEL;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DISABLE_EXTERNAL_FP_ANIM;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue USE_COMPATIBILITY_RENDERER;

    public static net.neoforged.neoforge.common.ModConfigSpec.DoubleValue SOUND_VOLUME;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue SHOW_MODEL_ID_FIRST;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue SOPHISTICATEDBACKPACK;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue PARCOOL;
    ...
    public static net.neoforged.neoforge.common.ModConfigSpec.EnumValue<RouletteContentMode> ROULETTE_CONTENT_MODE;
    ...
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue RESOURCE_STATION_MONITOR_LOG;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue NETWORK_ONLINE_DEBUG_LOG;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue MODEL_MEMORY_PROFILER;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue MODEL_IMPORT_PERFORMANCE_LOG;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue RELEASE_TEXTURE_BYTES_AFTER_UPLOAD;

    public static net.neoforged.neoforge.common.ModConfigSpec.IntValue AUDIO_CACHE_MAX_BYTES;

    public static net.neoforged.neoforge.common.ModConfigSpec.IntValue MAX_CACHED_GPU_MODELS;
    ...
    public static int safeInt(net.neoforged.neoforge.common.ModConfigSpec.IntValue value, int defaultValue) {
        if (value == null) {
            return defaultValue;
        }
        try {
    ...
    public static void defineGeneral(net.neoforged.neoforge.common.ModConfigSpec.Builder builder) {
