...
public final class ConfigPolicies {
    ...
    public static GraphicsPolicy graphics() { return new GraphicsPolicy(value(GeneralConfig.GRAPHICS_BACKEND_MODE, SmRenderBackendMode.AUTO), bool(GeneralConfig.ENABLE_OPENGL_LEGACY_GPU_RENDERER, false), bool(GeneralConfig.DISABLE_RAW_OPENGL_ON_NON_OPENGL, true), bool(GeneralConfig.ENABLE_OPENGL_GUI_BLUR, false), nativeSimdPolicy(value(GeneralConfig.NATIVE_SIMD_POLICY, GeneralConfig.NativeSimdPolicy.AGGRESSIVE)), nativeSimdValidationMode(value(GeneralConfig.NATIVE_SIMD_VALIDATION_MODE, GeneralConfig.NativeSimdValidationMode.OFF)), bool(GeneralConfig.EXPERIMENTAL_JAVA_VECTOR_RENDERER, false), bool(GeneralConfig.NATIVE_SIMD_COMPATIBILITY_LOG, false), bool(GeneralConfig.GPU_DEBUG_LOG, false), bool(GeneralConfig.GPU_DEBUG_VERBOSE_LOG, false)); }
